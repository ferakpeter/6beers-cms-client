...
let make = _children => {
  ...
  render: _self =>
    <div className="section section-terms" id="terms">
      ...
      <div className="row">
        <h1> (ReasonReact.string("Terms & Conditions")) </h1>
        <h3> (ReasonReact.string("1. Site Contents")) </h3>
        <p>
          (
            ReasonReact.string(
        ...
        <h3>
          (ReasonReact.string("3. Creative- and Trademarks"))
        </h3>
        <p>
          (
            ReasonReact.string(
        ...
        <h3> (ReasonReact.string("5. Privacy")) </h3>
        <p>
          (
            ReasonReact.string(
        ...
        <h3>
          (ReasonReact.string("6. Legal force of Disclaimer"))
        </h3>
        <p>
          (
            ReasonReact.string(
        ...
        <h3> (ReasonReact.string("7. Tracking")) </h3>
        <p>
          (
            ReasonReact.string(
        ...
        <h3> (ReasonReact.string("Google Analytics")) </h3>
        <p>
          (
            ReasonReact.string(
        ...
        <h3> (ReasonReact.string("8. Social Plugins")) </h3>
        <p>
          (
            ReasonReact.string(
  ...
  /* <h1>
       (ReasonReact.string("Allgemeine Geschäftsbedingungen"))
     </h1>
     <h3>
       (ReasonReact.string("1. Inhalt des Onlineangebotes"))
     </h3>
     <p>
       (
         ReasonReact.string(
     ...
     <h3> (ReasonReact.string("2. Verweise und Links")) </h3>
     <p>
       (
         ReasonReact.string(
     ...
     <h3>
       (ReasonReact.string("3. Urheber- und Kennzeichenrecht"))
     </h3>
     <p>
       (
         ReasonReact.string(
     ...
     <h3> (ReasonReact.string("5. Datenschutz")) </h3>
     <p>
       (
         ReasonReact.string(
